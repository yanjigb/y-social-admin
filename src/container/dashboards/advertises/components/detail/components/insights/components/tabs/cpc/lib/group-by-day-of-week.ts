...
export const GroupByDayOfWeek = (data: IResult[]): IChartData[] => {
  const weekDaysData: IWeekDaysData = {
    Mon: { impressions: 0, clicks: 0, conversions: 0, cost: 0, cpc: 0, date: '' },
    Tue: { impressions: 0, clicks: 0, conversions: 0, cost: 0, cpc: 0, date: '' },
    Wed: { impressions: 0, clicks: 0, conversions: 0, cost: 0, cpc: 0, date: '' },
    Thu: { impressions: 0, clicks: 0, conversions: 0, cost: 0, cpc: 0, date: '' },
    Fri: { impressions: 0, clicks: 0, conversions: 0, cost: 0, cpc: 0, date: '' },
    Sat: { impressions: 0, clicks: 0, conversions: 0, cost: 0, cpc: 0, date: '' },
    Sun: { impressions: 0, clicks: 0, conversions: 0, cost: 0, cpc: 0, date: '' },
  };
