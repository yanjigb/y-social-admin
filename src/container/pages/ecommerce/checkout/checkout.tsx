                                    ...
                                    <li className="list-group-item !border-t-0 !border-s-0 !border-e-0">
                                        <div className="flex items-center flex-wrap">
                                            ...
                                            <div>
                                                ...
                                                <p className="mb-0 text-[0.875rem] font-semibold">$189<span className="ms-1 text-[#8c9097] dark:text-white/50 text-[0.6875rem]"><s>$329</s></span></p>
                                            </div>
                                        </div>
                                    </li>
                                    <li className="list-group-item  !border-s-0 !border-e-0 dark:border-defaultborder/10 border-start-0 border-end-0">
                                        <div className="flex items-center flex-wrap">
                                            ...
                                            <div>
                                                ...
                                                <p className="mb-0 text-[0.875rem] font-semibold">$129<span className="ms-1 text-[#8c9097] dark:text-white/50 text-[0.6875rem]"><s>$139</s></span></p>
                                            </div>
                                        </div>
                                    </li>
                                </ul>
