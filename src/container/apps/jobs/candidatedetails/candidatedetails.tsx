                                    ...
                                    <SwiperSlide className="rtl:dir-rtl">
                                        <div className="box custom-box">
                                            <div className="box-body">
                                                ...
                                                <div className="popular-tags space-x-1 rtl:space-x-reverse">
                                                    <Link to="#" className="badge !rounded-full bg-light !text-defaulttextcolor"><i className="bi bi-mortarboard text-[#8c9097] dark:text-white/50 me-1"></i> Graduate</Link>
                                                    <Link to="#" className="badge !rounded-full bg-light !text-defaulttextcolor"><i className="bi bi-moon-stars text-[#8c9097] dark:text-white/50 me-1"></i> sm:flexible-shift</Link>
                                                    <Link to="#" className="badge !rounded-full bg-light !text-defaulttextcolor"><i className="bi bi-clock text-[#8c9097] dark:text-white/50 me-1"></i> Immediate Joinee</Link>
                                            ...
                                            <div className="box-footer">
                                                <div className="sm:flex items-center gap-3">
                                                    ...
                                                    <div className="popular-tags sm:flex-grow space-x-1 rtl:space-x-reverse ">
                                                        ...
                                                        <Link to="#" className="badge !rounded-full bg-light !text-defaulttextcolor">Javascript</Link>
                                                        <Link to="#" className="badge !rounded-full bg-light !text-defaulttextcolor">React Navtive</Link>
                                                        <Link to="#" className="badge !rounded-full bg-primary/10 text-primary"><i className="bi bi-plus"></i> More</Link>
                                                    </div>
                                                    <div>
