                            ...
                            <div className="grid grid-cols-12 gap-4">
                                ...
                                <div className="xl:col-span-12 col-span-12">
                                    <div>
                                        ...
                                        <textarea className="form-control w-full !rounded-md !bg-light" id="invoice-note" rows={3} defaultValue="Once the invoice has been verified by the accounts payable team and recorded, the only task left is to send it for approval before
