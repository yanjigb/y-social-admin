                                    ...
                                    <form className="!px-6 !py-4">
                                        ...
                                        <div className="mb-4">
                                            <div className="form-check !ps-0">
                                                <input type="checkbox" className="form-check-input" id="dropdownCheck" defaultChecked />
                ...
                <div className="xl:col-span-3 col-span-12">
                    <Showcode title="Dark Dropdowns" code={dropdown16}>
                            <div className="ti-dropdown hs-dropdown">
                                ...
                                <ul
                                    className="hs-dropdown-menu ti-dropdown-menu !bg-black dark:!bg-defaulttextcolor/10 hidden">
