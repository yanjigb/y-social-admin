            ...
            <div className="box-body">
              <form className="ti-custom-validation" noValidate>
                ...
                <div className="my-5">
                  ...
                  <label htmlFor="hs-checkbox-group-12" className="text-sm text-gray-500 sm:ms-3 dark:text-[#8c9097] dark:text-white/50">I agree with the <Link to="#" className="text-primary hover:underline">terms and conditions</Link></label>
                </div>
