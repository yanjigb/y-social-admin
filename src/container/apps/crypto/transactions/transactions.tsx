                            ...
                            <div className="box-body !p-0">
                                <div className="p-6 border-b dark:border-defaultborder/10 border-dashed flex items-start flex-wrap gap-2">
                                    ...
                                    <div className="flex-grow">
                                        ...
                                        <div className="pb-0 mt-0">
                                            <div>
                                                <h4 className="text-[1.125rem] font-semibold mb-2"><span className="count-up" data-count="42">42</span><span className="text-[#8c9097] dark:text-white/50 ltr:float-right rtl:float-left text-[.6875rem] font-normal">Last Year</span></h4>
                                ...
                                <div className="p-4 border-b dark:border-defaultborder/10 border-dashed flex items-start flex-wrap gap-2">
                                    ...
                                    <div className="flex-grow">
                                        ...
                                        <div>
                                            <h4 className="text-[1.125rem] font-semibold mb-2"><span className="count-up" data-count="319">320</span><span className="text-[#8c9097] dark:text-white/50 ltr:float-right rtl:float-left text-[.6875rem] font-normal">Last Year</span></h4>
                                            <p className="text-[#8c9097] dark:text-white/50 text-[.6875rem] mb-0 leading-none">
                                ...
                                <div className="flex items-start p-4 border-b dark:border-defaultborder/10 border-dashed flex-wrap gap-2">
                                    ...
                                    <div className="flex-grow">
                                        ...
                                        <div>
                                            <h4 className="text-[1.125rem] font-semibold mb-2"><span className="count-up" data-count="81">82</span><span className="text-[#8c9097] dark:text-white/50 ltr:float-right rtl:float-left text-[.6875rem] font-normal">Last Year</span></h4>
                                            <p className="text-[#8c9097] dark:text-white/50 text-[.6875rem] mb-0 leading-none">
                                                <span className="text-success me-1 font-semibold">
                                ...
                                <div className="flex items-start p-4 border-b dark:border-defaultborder/10 border-dashed flex-wrap gap-2">
                                    ...
                                    <div className="flex-grow">
                                        ...
                                        <div>
                                            <h4 className="text-[1.125rem] font-semibold mb-2"><span className="count-up" data-count="32">33</span><span className="text-[#8c9097] dark:text-white/50 ltr:float-right rtl:float-left text-[.6875rem] font-normal">Last Year</span></h4>
                                            <p className="text-[#8c9097] dark:text-white/50 text-[.6875rem] mb-0 leading-none">
