              ...
              <tbody>
                {adsList.map((ads) => (
                  ...
                  >
                    ...
                    <td>
                      <div
                        className={`py-1 px-2 text-white text-center rounded-md font-bold ${
                          ads.status ? "bg-success" : "bg-danger"
                        }`}
                      >
                    ...
                    <td>
                      <div
                        className={`py-1 px-2 text-white text-center rounded-md font-bold ${
                          ads.score > 70 ? "bg-success" : "bg-danger"
                        }`}
                      >
                        {ads.score > 70 ? "Very Good" : "Bad"}
                      </div>
                    </td>
                    <td>
                      {formatDate(
