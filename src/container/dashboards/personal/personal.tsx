                                ...
                                <div className="box-body !p-0">
                                    <div className="flex flex-wrap items-center border-b border-dashed dark:border-defaultborder/10">
                                        <div className="px-6 py-4 flex-grow border-e border-dashed dark:border-defaultborder/10">
                                            ...
                                            <div className="flex-between">
                                                <span className="text-[#8c9097] dark:text-white/50 text-[0.75rem]">6 min ago</span>
                                        ...
                                        <div className="px-6 py-4 flex-grow border-b border-dashed dark:border-defaultborder/10">
                                            ...
                                            <div className="flex-between">
                                                <span className="text-[#8c9097] dark:text-white/50 text-[0.75rem]">1 hr ago</span>
                                    ...
                                    <div className="flex flex-wrap items-center">
                                        <div className="px-6 py-4 flex-grow border-e border-dashed dark:border-defaultborder/10">
                                            ...
                                            <div className="flex-between">
                                                <span className="text-[#8c9097] dark:text-white/50 text-[0.75rem]">1 day ago</span>
                                        ...
                                        <div className="px-6 py-4 flex-grow border-dashed dark:border-defaultborder/10">
                                            ...
                                            <p className="mb-2 text-[1.5rem] font-semibold">2.1K</p>
                                            <div className="flex-between">
                                                <span className="text-[#8c9097] dark:text-white/50 text-[0.75rem]">1 week ago</span>
