                        ...
                        <div className="box-body">
                            <div className="grid grid-cols-12">
                                <div className="col-span-6 pe-0">
                                    ...
                                    <Link to="#" className="text-[0.75rem] mb-0 text-primary">Show full stats<i className="ti ti-chevron-right ms-1"></i></Link>
                                </div>
                                    ...
                                    <div className="text-[0.75rem]">
                                        <p className="mb-0">
                                            ...
                                            <span className="ms-2 text-[0.75rem]">shared a page.
                                                <Link to="https://themeforest.net/user/spruko/portfolio" target="_blank" className="text-success underline text-[0.6875rem]">https://themeforest.net/portfolio</Link>
                                            </span>
                                        </p>
                                    </div>
