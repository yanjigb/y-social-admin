      ...
      <div className="sm:flex items-start p-6 border-b border-dashed border-defaultborder dark:border-defaultborder/10 main-profile-cover">
        ...
        <div className="flex-fill main-profile-info w-full">
          <div className="flex items-center justify-between">
            <h6 className="font-semibold mb-1 text-white">{(user.firstName?.trim() || user.lastName?.trim())
          ...
          <p className="text-[0.75rem] text-white mb-4 opacity-50">
            <span><i className="ri-map-pin-line me-1 align-middle"></i>VIETNAM</span>
          </p>
          <div className="flex mb-0">
            <div className="me-4">
              <p className="font-bold text-xl text-white text-shadow mb-0">{user.followers?.length || 0}</p>
              <p className="mb-0 text-[0.6875rem] opacity-50 text-white">Followers</p>
            </div>
            <div className="me-4">
              <p className="font-bold text-xl text-white text-shadow mb-0">{user.followings?.length || 0}</p>
              <p className="mb-0 text-[0.6875rem] opacity-50 text-white">Followings</p>
            </div>
          </div>
        </div>
      </div>
