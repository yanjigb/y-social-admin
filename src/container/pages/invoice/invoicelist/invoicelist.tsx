                        ...
                        <div className="box-body !p-0">
                            <div className="p-6 border-b border-dashed dark:border-defaultborder/10 flex items-start">
                                ...
                                <div className="flex-grow">
                                    ...
                                    <div className="pb-0 mt-0">
                                        <div>
                                            <h4 className="text-[1.125rem] font-semibold mb-2">$<span className="count-up" data-count="192">192</span>.87K</h4>
                            ...
                            <div className="p-6 border-b border-dashed dark:border-defaultborder/10 flex items-start">
                                ...
                                <div className="flex-grow">
                                    ...
                                    <div>
                                        <h4 className="text-[1.125rem] font-semibold mb-2">$<span className="count-up" data-count="68.83">68.83</span>K</h4>
                                        <p className="text-[#8c9097] dark:text-white/50 text-[.6875rem] mb-0 leading-none">
                            ...
                            <div className="flex items-start p-6 border-b dark:border-defaultborder/10 border-dashed">
                                ...
                                <div className="flex-grow">
                                    ...
                                    <div>
                                        <h4 className="text-[1.125rem] font-semibold mb-2">$<span className="count-up" data-count="81.57">81.57</span>K</h4>
                                        <p className="text-[#8c9097] dark:text-white/50 text-[.6875rem] mb-0 leading-none">
                                            <span className="text-success me-1 font-semibold">
                            ...
                            <div className="flex items-start p-6 border-b dark:border-defaultborder/10 border-dashed">
                                ...
                                <div className="flex-grow">
                                    ...
                                    <div>
                                        <h4 className="text-[1.125rem] font-semibold mb-2">$<span className="count-up" data-count="32.47">32.47</span>K</h4>
                                        <p className="text-[#8c9097] dark:text-white/50 text-[.6875rem] mb-0 leading-none">
